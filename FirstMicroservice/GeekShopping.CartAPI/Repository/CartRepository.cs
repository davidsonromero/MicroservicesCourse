    ...
    public class CartRepository : ICartRepository
    {
        ...
        public async Task<bool> RemoveFromCart(long cartDetailsId)
        {
            try
            {
                ...
                if(total == 1)
                {
                    CartHeader? cartHeaderToRemove = await _context.CartHeaders.FirstOrDefaultAsync(c => c.Id == cartDetail.CartHeaderId);
        ...
        public async Task<CartVO> SaveOrUpdateCart(CartVO vo)
        {
            ...
            CartHeader? cartHeader = await _context.CartHeaders.AsNoTracking().FirstOrDefaultAsync(c => 
            ...
            {
                CartDetail? cartDetail = await _context.CartDetails.AsNoTracking().FirstOrDefaultAsync(p =>
                    p.ProductId == vo.CartDetails.FirstOrDefault().ProductId && p.CartHeaderId == cartHeader.Id);
